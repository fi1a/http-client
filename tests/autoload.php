...
use Fi1a\Unit\HttpClient\Fixtures\HttpProxy\HttpProxy;
use Fi1a\Unit\HttpClient\Fixtures\Server\Server;
use Fi1a\Unit\HttpClient\Fixtures\Socks5Proxy\Socks5Proxy;

require_once __DIR__ . '/../vendor/autoload.php';
require_once __DIR__ . '/define.php';

$server = new Server();
$server->start((int) WEB_SERVER_HTTPS_PORT, (int) WEB_SERVER_HTTP_PORT);
